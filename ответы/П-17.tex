...
\begin{flalign*}
    \begin{split}
        ...
        =&
        \sum_{A}\left(q_A F\indices{^\alpha_\beta}\frac{dx_A^\beta}{dt}\right)\delta(\vec{x}-\vec{x}_A)
        =
        F\indices{^\alpha_\beta}\sum_{A}q_A \frac{dx_A^\beta}{dt}\delta(\vec{x}-\vec{x}_A)
        =\\
        =&
